...
export const WAVES: WaveConfig[] = [
  ...
  { wave: 4, spawnInterval: 1400, maxConcurrentEnemies: 18 },
  {
    ...
    enemyWeightOverrides: { baguette: 8 },
  },
  { wave: 6, spawnInterval: 1100, maxConcurrentEnemies: 25 },
  {
    ...
    enemyWeightOverrides: { doughnut: 15 },
  },
  { wave: 8, spawnInterval: 900, maxConcurrentEnemies: 32 },
  {
    ...
    enemyWeightOverrides: { baguette: 10, doughnut: 10 },
  },
  { wave: 10, spawnInterval: 700, maxConcurrentEnemies: 45 },
];