...
const MiningProgressUI: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div
        style={{
          color: isComplete ? '#aaffaa' : '#ccddff',
          fontSize: '13px',
          fontWeight: 700,
          letterSpacing: '2px',
          textTransform: 'uppercase',
          textShadow: isComplete ? '0 0 12px #44ff88' : '0 0 8px #4488ff',
          fontFamily: "'Segoe UI', system-ui, sans-serif",
          transition: 'color 0.2s, text-shadow 0.2s',
        }}
      >
        {isComplete ? '✓ COLLECTED!' : '✨ EXTRACTING…'}
      </div>
        ...
        <div
          style={{
            ...
            background: isComplete
              ? 'linear-gradient(90deg, #67e8f9, #cffafe)'
              : 'linear-gradient(90deg, #0891b2, #06b6d4)',
            boxShadow: isComplete ? '0 0 10px #67e8f9' : '0 0 8px #0891b2',
