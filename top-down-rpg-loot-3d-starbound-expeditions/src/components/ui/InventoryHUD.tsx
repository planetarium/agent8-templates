    ...
    >
      ...
      >
        <svg viewBox="0 0 24 24" width="30" height="30" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M12 2L15.09 8.26L22 9.27L17 14.14L18.18 21.02L12 17.77L5.82 21.02L7 14.14L2 9.27L8.91 8.26L12 2Z" fill="url(#cg1)" stroke="#0891b2" strokeWidth="0.5"/>
        </svg>
      </div>
      ...
      <button
        ...
        style={{
          ...
          border: '1px solid rgba(160, 100, 255, 0.5)',
            ...
            ? 'rgba(6, 182, 212, 0.4)'
            : 'linear-gradient(135deg, rgba(6, 182, 212, 0.6), rgba(8, 145, 178, 0.6))',
          color: connected ? '#cffafe' : 'rgba(103, 232, 249, 0.4)',
          fontSize: '10px',
          fontWeight: 700,
          letterSpacing: '1px',
          textTransform: 'uppercase',
