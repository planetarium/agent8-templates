...
## Current Game: SHADOW NINJA

| Element | Implementation |
|---------|---------------|
| Theme | Dark Japanese fantasy survival — ninja slays demon hordes |
| Player | Shadow Ninja (`ninja` spritesheet) — shuriken auto-fire, 180 speed, 3 HP |
| Enemies | Oni Demon (chase), Yurei Ghost, Dai-Tengu |
| Drop/Currency | `credits` (Demon Gold) |
| Score | Wave-based survival with XP/level-up ability system |
