/**
 * Wave progression for Shadow Ninja: Demon Slayer.
 * 10 escalating waves of demon attacks.
 */
...
export const WAVES: WaveConfig[] = [
  ...
  { wave: 4, spawnInterval: 1500, maxConcurrentEnemies: 18 },
  {
    ...
    enemyWeightOverrides: { daitengu: 8 },
  },
  ...
  { wave: 8, spawnInterval: 950, maxConcurrentEnemies: 34 },
  {
    ...
    enemyWeightOverrides: { daitengu: 12, yurei: 12 },
  },
