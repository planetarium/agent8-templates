    ...
    <div className={styles.root}>
      ...
      <div className={styles.content}>
        <div className={styles.logo}>
          ...
          <span className={styles.logoText}>DRAGON FORGE</span>
          <span className={styles.logoIcon}>&#x1F525;</span>
        </div>
        <div className={styles.subtitle}>VOLCANIC SHMUP</div>
        ...
        <div className={styles.barLabel}>FORGING... {Math.floor(progress * 100)}%</div>
