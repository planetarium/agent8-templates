/**
 * Wave progression for Shadow Dynasty.
 * 10 escalating crusades of holy warriors.
 */
...
export const WAVES: WaveConfig[] = [
  ...
  { wave: 4, spawnInterval: 1500, maxConcurrentEnemies: 18 },
  {
    ...
    enemyWeightOverrides: { archangel: 8 },
  },
  { wave: 6, spawnInterval: 1200, maxConcurrentEnemies: 26 },
  {
    ...
    enemyWeightOverrides: { templar: 14 },
  },
  { wave: 8, spawnInterval: 950, maxConcurrentEnemies: 34 },
  {
    ...
    enemyWeightOverrides: { archangel: 12, templar: 12 },
  },
