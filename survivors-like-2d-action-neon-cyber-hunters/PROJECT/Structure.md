...
## Current Game: NEON CYBER HUNTERS

| Element | Implementation |
|---------|---------------|
| Theme | Cyberpunk neon-lit world — Cyber Hunter vs digital threats |
| Player | Hunter (`hunter` spritesheet) — neon pulse auto-fire, 220 speed, 5 HP |
| Enemies | Cyber Drone (chase), Virus Spider (swarm, fast), Glitch Beast (tank) |
| Abilities | Overclock, Nitro Boost, Nano Repair, Plasma Core, Hyper Rail, Split Shot, Beam Pierce, Glitch Wave |
| Background | Neon grid cyberpunk environment |
| Currency | Energy Cores (`gold` key in server.js), labeled as CORES |
...
server.js                                [CHANGE if renaming currency] asset key: 'gold'
...
If renaming `'gold'` to another key, sync 3 locations atomically:
