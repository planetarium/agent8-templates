/**
 * basic-3d-quarterview on Incanto: the classic fixed isometric camera
 * (35.264° pitch, distance 40, FOV 20), world-relative WASD, Shift sprint,
 * Space jump — no mouse look, the camera angle never changes.
 */
  ...
  useEffect(() => {
    ...
    void (async () => {
      ...
      const game = await createGame3D({
        ...
        pointer: { lockOnClick: false }, // no pointer lock: the quarter camera is fixed
      });
