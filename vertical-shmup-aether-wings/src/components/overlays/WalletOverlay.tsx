      ...
      <div className={styles.panel}>
        ...
        <div className={styles.infoCards}>
          <div className={styles.card}>
            ...
            <div className={styles.cardText}>Gather {collectibleName} essence in battle</div>
          </div>
          <div className={styles.card}>
            <div className={styles.cardIcon}>🔗</div>
            <div className={styles.cardText}>Redeem for {tokenSymbol} celestial tokens</div>
          </div>
        </div>
        ...
        <div className={styles.tokenBadge}>
          ...
          <span className={styles.tokenName}>Celestial Glow Token</span>
