    ...
    <div className={`${styles.root} ${styles.visible}`}>
      ...
      <div className={styles.panel}>
        ...
        <div className={styles.header}>
          <div className={styles.title}>BATTLE ENDED</div>
        ...
        <div className={styles.stats}>
          <div className={styles.statRow}>
            <span className={styles.statLabel}>GLORY</span>
          ...
          {isNewBest && (
            <div className={styles.newBest}>✧ NEW DIVINE BEST ✧</div>
          )}

          <div className={styles.divider} />

          <div className={styles.statRow}>
            <span className={styles.statLabel}>CELESTIAL WAVE</span>
            <span className={`${styles.statValue} ${styles.statBlue}`}>{data.wave}</span>
          </div>

          <div className={styles.statRow}>
            <span className={styles.statLabel}>{collectibleName} ESSENCE</span>
          ...
          {data.stardust > 0 && (
            <div className={styles.exchangeHint}>
              {data.stardust} {collectibleName.toLowerCase()} → {Math.floor(data.stardust / exchangeRate)} {tokenSymbol} token{data.stardust >= exchangeRate ? 's' : ''}
            </div>
          )}
        </div>
