  ...
  useFrame((_, delta) => {
    ...
    for (let i = 0; i < particlesRef.current.length; i++) {
      ...
      if (t < 1) {
        ...
        p.velocity.y -= 2 * delta; // lighter gravity for floaty ember feel
