    ...
    <>
      ...
      <button
        ...
        style={{
          ...
          height: 40,
          borderRadius: '50%',
          border: '1px solid rgba(204, 136, 48, 0.25)',
          background: open ? 'rgba(26, 14, 5, 0.95)' : 'rgba(26, 14, 5, 0.75)',
      ...
      {open && (
        <div
          style={{
            ...
            border: '1px solid rgba(204, 136, 48, 0.2)',
            borderRadius: '14px',
            padding: '16px',
        ...
        >
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    padding: '10px 12px',
                    borderRadius: '10px',
                    border: selected ? `1px solid ${color}66` : '1px solid rgba(204,136,48,0.1)',
                    background: selected ? `rgba(${hexToRgb(color)}, 0.12)` : 'rgba(255,255,255,0.02)',
                    color: selected ? color : 'rgba(232,200,128,0.5)',
                    cursor: 'pointer',
                ...
                >
                  ...
                  <div style={{ fontSize: '11px', color: 'rgba(232,200,128,0.4)', lineHeight: 1.4 }}>
          ...
          {showReloadHint && (
            <div
              style={{
                ...
                padding: '8px 12px',
                borderRadius: '8px',
                background: 'rgba(204, 136, 48, 0.1)',
            ...
            >
              ...
              <button
                ...
                style={{
                  ...
                  borderRadius: '6px',
                  border: '1px solid rgba(204,136,48,0.3)',
                  background: 'rgba(204,136,48,0.15)',
                  color: '#e8c880',
                  fontSize: '11px',
                  fontWeight: 700,
                  cursor: 'pointer',
          ...
          <button
            ...
            style={{
              ...
              padding: '7px',
              borderRadius: '8px',
              border: '1px solid rgba(204,136,48,0.15)',
              background: 'rgba(204,136,48,0.06)',
              color: 'rgba(232,200,128,0.5)',
              fontSize: '12px',
              cursor: 'pointer',
              letterSpacing: '0.5px',
              minHeight: 40,
