    ...
    <div className={`${styles.root} ${styles.visible}`}>
      ...
      <div className={styles.panel}>
        ...
        <div className={styles.header}>
          <div className={styles.title}>SURFACED</div>
        ...
        <div className={styles.stats}>
          ...
          <div className={styles.statRow}>
            <span className={styles.statLabel}>DEPTH REACHED</span>
          ...
          {data.stardust > 0 && (
            <div className={styles.exchangeHint}>
              {data.stardust} pearls → {Math.floor(data.stardust / 100)} REEF token{data.stardust >= 100 ? 's' : ''}
            </div>
          )}
        </div>
