    ...
    <>
      ...
      <button
        ...
        style={{
          ...
          background: open ? 'rgba(40, 12, 0, 0.95)' : 'rgba(20, 5, 0, 0.75)',
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    padding: '10px 12px',
                    borderRadius: '10px',
                    border: selected ? `1px solid ${color}66` : '1px solid rgba(255,100,0,0.15)',
                    background: selected ? `rgba(${hexToRgb(color)}, 0.15)` : 'rgba(255,255,255,0.03)',
                    color: selected ? color : 'rgba(255,200,150,0.65)',
                    cursor: 'pointer',
                ...
                >
                  ...
                  <div style={{ fontSize: '11px', color: 'rgba(255,160,80,0.5)', lineHeight: 1.4 }}>
