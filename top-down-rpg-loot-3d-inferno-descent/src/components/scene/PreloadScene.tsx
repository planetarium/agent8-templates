...
const PreloadScene: React.FC<PreloadSceneProps> = ({ onComplete }) => {
  ...
  return (
    ...
    >
      <h2 style={{ fontSize: '1.5rem', fontWeight: 'bold', marginBottom: '1rem', letterSpacing: '3px', textShadow: '0 0 10px rgba(255,80,0,0.5)' }}>
        FORGING...
      </h2>
      <div style={{ width: '256px', height: '8px', backgroundColor: 'rgba(255,60,0,0.15)', borderRadius: '9999px', overflow: 'hidden', border: '1px solid rgba(255,80,0,0.3)' }}>
        <div
          style={{
            height: '100%',
            background: 'linear-gradient(90deg, #cc3300, #ff6600, #ffaa00)',
            borderRadius: '9999px',
      ...
      <p style={{ marginTop: '0.5rem', fontSize: '0.9rem', color: '#cc6633' }}>{progress}%</p>
    </div>
  );
};
