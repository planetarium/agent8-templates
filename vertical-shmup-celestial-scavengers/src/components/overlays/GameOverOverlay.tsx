    ...
    <div className={`${styles.root} ${styles.visible}`}>
      ...
      <div className={styles.panel}>
        ...
        <div className={styles.header}>
          <div className={styles.title}>GARDEN RETURN</div>
        ...
        <div className={styles.stats}>
          <div className={styles.statRow}>
            <span className={styles.statLabel}>SOUL RESONANCE</span>
          ...
          {isNewBest && (
            <div className={styles.newBest}>✧ HIGHER ASCENSION ✧</div>
          )}

          <div className={styles.divider} />

          <div className={styles.statRow}>
            <span className={styles.statLabel}>LAYERS TRAVERSED</span>
            <span className={`${styles.statValue} ${styles.statBlue}`}>{data.wave}</span>
          </div>

          <div className={styles.statRow}>
            <span className={styles.statLabel}>SPIRIT SHARDS</span>
          ...
          {data.stardust > 0 && (
            <div className={styles.exchangeHint}>
              {data.stardust} shards collected → {Math.floor(data.stardust / 100)} CST token{data.stardust >= 100 ? 's' : ''} earned
            </div>
          )}
        </div>
